...
const GeorefLocationSelector = ({ onChange }) => {
  ...
  useEffect(() => {
    if (selectedMunicipio && selectedProvincia) {
  ...
  return (
    <div className="georef-selectors">
      ...
      <select value={selectedLocalidad} onChange={(e) => setSelectedLocalidad(e.target.value)} disabled={!localidades.length}>
